...
В проекте имеются файлы docker-compose.yml и docker-compose.production.yml. Они совсем немного отличаются: в docker-compose.yml образы билдятся, а в docker-compose.production.yml скачиваются с Docker Hub.
